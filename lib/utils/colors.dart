...
class AppColors {
  static final Color mainColor = const Color(0xfff53c27);
  static final Color textColor = const Color(0xFF89dad0);
  static final Color iconColor1 = const Color(0xFFffd23d);
  static final Color iconColor2 = const Color(0xFFfcab88);
  static const defultColor = const Color(0xFFfcab88);
